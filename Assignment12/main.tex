...
\begin{lstlisting}
https://github.com/Gayathri1729/SRFP/tree/main/Assignment12
\end{lstlisting}
%
...
\section{PROBABILITY 2.18}
 A man is known to speak truth 3 out of 4
...
\begin{align}
Pr(X=0|Y=0)&= \frac{Pr(Y=0|X=0)Pr(X=0)}{\sum_{i=0}^{1}{Pr}(Y=0|X=i)Pr(X=i)} \label{eq:1}
\end{align}
Substituting the given values in \eqref{eq:1},
\begin{align}
  Pr(X=0|Y=0)&=\frac{\frac{1}{6}\frac{3}{4}}{\frac{1}{6}\frac{3}{4}+\frac{5}{6}\frac{1}{4}} 
  &= \frac{3}{8}
\end{align}
Thus, the probability that the die shows 6 given the man reports it is six is 0.375 .

i.e., $Pr(X=0|Y=0)=\frac{3}{8}$.
